...
@section('content')
<div class="container">
    <form action="{{ route('holidays.insert')}}" method="post">
    @csrf
        <div class="row">
            <div class="title">
                ...
                <div class="card border-primary mb-3">
                    <div class="card-body text-primary">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" value="{{ old('startDate') }}" class="form-control @error('startDate') is-invalid @enderror" name="startDate" id="startDate" placeholder="Enter date">
                        </div>
                        <div class="form-group">
                            <label for="endDate">End Date</label>
                            <input type="date" value="{{ old('endDate') }}" class="form-control @error('endDate') is-invalid @enderror" name="endDate" id="endDate" placeholder="Enter date">
                        </div>   
                        <div class="form-check">
                            <input checked class="form-check-input" value="{{ old('fullDay') }}" type="checkbox" name="fullDay" id="fullDay">
